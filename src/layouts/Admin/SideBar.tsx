  ...
  return (
    <>
      ...
      <Menu theme="light" mode="inline">
        ...
        {role === "A_1" && (
          <Menu.Item key="2">
            <NavLink to="/all_corporates">
              <span
                className="icon"
                style={{
                  background: page === "all_corporates" ? color : "",
                }}
              >
                {tables}
              </span>
              <span className="label">Corporate Societies</span>
            </NavLink>
          </Menu.Item>
        )}
        <Menu.Item key="3">
      ...
      <div className="aside-footer">
        ...
        >
          ...
          <h6>Need Help?</h6>
          <p>Please check the system Guide</p>
          <Button type="primary" className=" text-center h-4 ">
            Guide
          </Button>
        </div>
      </div>
